...
describe Psychgus::SuperSniffer do
  it 'should sniff multiple docs' do
    _(Psychgus.hierarchy(
      TestHelper::BURGERS_DATA,
      TestHelper::COURSES_DATA,
      TestHelper::DOLPHINS_DATA,
      verbose: true,
    )).must_equal(<<~HIER)
  ...
  it 'should sniff a single doc' do
    ...
    _(Psychgus.hierarchy(TestHelper::COURSES_DATA,verbose: true)).must_equal(<<~HIER)
      (1:1):Psych::Nodes::Stream - <root:(0:0)::(:1)>
      (1:1):Psych::Nodes::Document - <stream:(1:1)::(:1)>
      (1:1):Psych::Nodes::Mapping - <doc:(1:1)::(:1)>
